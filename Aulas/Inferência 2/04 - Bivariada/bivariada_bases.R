...
setwd(choose.dir()) # setwd("C:/Users/User/Documents/Disciplinas/Pós estatistica/04 - Bivariada")
...
####### Teste t de Student populações indenpendentes #############
...
plot(d_Cohen, xlab = 'número amostral')
